...
},{"buffer":"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/moment/moment.js":[function(require,module,exports) {
var define;
var global = arguments[3];
//! moment.js
//! version : 2.29.1
...
console.log(c);
var dateDays = moment().add(7, 'days').calendar();
console.log(dateDays);
var months = moment().add(7, 'months').calendar();
console.log(months);
var years = moment().add(10, 'years').calendar();
console.log(years);
var subDate = moment().subtract(7, 'days').calendar();
console.log(subDate);
var subMonths = moment().subtract(7, 'months').calendar();
